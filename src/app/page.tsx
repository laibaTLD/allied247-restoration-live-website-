...
export async function generateMetadata(): Promise<Metadata> {
  ...
  // Use specific home page meta title and description
  const resolvedTitle = 'Allied 24/7 Restoration - Professional Restoration Services in Montana';
  const resolvedDescription = 'Allied 24/7 Restoration provides expert water damage, fire damage, mold remediation, and reconstruction services in Kalispell, MT and surrounding areas. 24/7 emergency response.';
